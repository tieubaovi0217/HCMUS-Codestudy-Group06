      ...
      <BrowserRouter style={{ height: "100vh" }}>
        <div className="container">
          ...
          <div>
            <div className="mt-2 d-flex align-items-center">
              ...
              <NavLink
                exact
                to={this.state.link1}
                className="nav-link border border-primary rounded mr-2"
              >
                {this.state.button1}
              </NavLink>
              ...
              <NavLink
                exact
                to={this.state.link2}
                className="nav-link border border-primary rounded"
                onClick={this.handleOnClickButton2}
              >
                {this.state.button2}
              </NavLink>
            </div>
          ...
          <Switch>
            ...
            <Route
              exact
              path="/problemset/viewproblem/:id"
              render={(props) => {
                return <ViewProblem {...props} />;
              }}
            />
